...
interface ConstraintsState {
  activeTab: 'travail' | 'activite' | 'routine' | 'trajet' | 'revisions' | 'autres';
}
...
interface NavigationStateContextType {
  ...
  setConstraintsTab: (tab: 'travail' | 'activite' | 'routine' | 'trajet' | 'revisions' | 'autres') => void;
}
...
export const NavigationStateProvider = ({ children }: { children: ReactNode }) => {
  ...
  const setConstraintsTab = (tab: 'travail' | 'activite' | 'routine' | 'trajet' | 'revisions' | 'autres') => {
    setState(prev => ({
      ...prev,
